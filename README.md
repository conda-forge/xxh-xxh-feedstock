...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xxh-xxh-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10736&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xxh-xxh-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xxh-xxh` can be installed with:

```
conda install xxh-xxh
```

It is possible to list all of the versions of `xxh-xxh` available on your platform with:
